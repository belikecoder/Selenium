...
import java.net.URL;
public class ClassExercise1Test {
  ...
  public void classExercise1() {
    ...
    driver.findElement(By.id("input-email")).sendKeys("727721euit176@skcet.ac.in");
    driver.findElement(By.id("input-password")).click();
    driver.findElement(By.id("input-password")).sendKeys("VIKEY0424");
